...
var (
	...
	PixiechainStartFlag = cli.Uint64Flag{
		Name:  "pixiechain",
		Usage: "pixiechain start block height ",
		Value: uint64(0),
	}

	PixiechainStartForceFlag = cli.Uint64Flag{
		Name:  "hforce",
		Usage: "pixiechain forcely start block height ",
		Value: uint64(0),
	}
