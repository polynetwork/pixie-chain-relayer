...
func NewServiceConfig(configFilePath string) *ServiceConfig {
	...
	for k, v := range servConfig.PixiechainConfig.KeyStorePwdSet {
		delete(servConfig.PixiechainConfig.KeyStorePwdSet, k)
		servConfig.PixiechainConfig.KeyStorePwdSet[strings.ToLower(k)] = v
	}
